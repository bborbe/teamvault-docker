...
Docker image + compose setup for running [TeamVault](https://github.com/seibert-media/teamvault).
...
<https://github.com/seibert-media/teamvault/tags>

```bash
VERSION=0.11.7 make build
```

Push to your own registry:

```bash
REGISTRY=docker.io IMAGE=yourname/teamvault VERSION=0.11.7 make build upload
```
...
- `postgres:16`
- `docker.io/bborbe/teamvault:${VERSION:-0.11.7}`
...
- TeamVault upstream: <https://github.com/seibert-media/teamvault>
